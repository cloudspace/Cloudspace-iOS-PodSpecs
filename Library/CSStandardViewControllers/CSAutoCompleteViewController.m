...
- (void)viewDidLoad
{
  ...
  self.tableView_results.tableViewStyle = [[CSEnhancedTableViewStyleDark alloc] init];
  
  // Enable cancel button immediately
...
/**
 * Removes the autoCompleteData observer
 */
- (void)dealloc
{
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
  ...
  //
  CSEnhancedTableViewHeaderFooterView *header = [self.tableView_results dequeueReusableHeaderFooterViewWithIdentifier:@"feedSearchHeader"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  CSEnhancedTableViewCell *cell = [self.tableView_results dequeueReusableCellWithIdentifier:@"feedSearchCell"];
...
- (void) didTapRow:(id)sender
{
  ...
  CSEnhancedTableViewCell *cell = (CSEnhancedTableViewCell *)[[tapRecognizer.view superview] superview];
